...
let subTitleCourse =
  'Learn all the Intermediate and Advanced Level of the language';
...
function printTheCourse(
  theTitle: string,
  theSubTitle: string,
  theLessonsCount: number
) {
